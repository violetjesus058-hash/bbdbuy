...
Whether you are restocking a streetwear closet, buying a single winter puffer, or sourcing for a small resale shop, this guide gives you the numbers you need before you click "add to cart." We will also link to our [Kakobuy sizing guide](/blog/kakobuy-sizing-guide/) so you get the fit right the first time, and our [Kakobuy palm angels](/blog/kakobuy-palm-angels/) breakdown if you are specifically after that label. Let us get into it.
...
**Luxury designer jackets** cover Moncler, Palm Angels, Stone Island and Ralph Lauren. There are roughly 210 SKUs here, with order counts lower (40¨C120 units per SKU) but average order value much higher. Quality pass rates are reported at 96.8 %, reflecting tighter factory QC on higher-ticket items. If you are exploring this tier, our [Kakobuy palm angels](/blog/kakobuy-palm-angels/) guide covers that brand in more depth.
...
| Under Armour Jacket | ~$49.29 | $110¨C$140 | 55¨C65 % |
| Moncler Down Jacket | ~$78.57 | $1,300¨C$2,000 | 94¨C96 % |
| Stone Island Down Jacket | ~$35.60 | $400¨C$600 | 91¨C94 % |
| Stussy Down Jacket | ~$26.21 | $250¨C$350 | 89¨C92 % |
| Canada Goose Down Jacket | ~$68.68 | $1,000¨C$1,400 | 93¨C95 % |
| Nike Nocta Down Jacket | ~$67.31 | $350¨C$500 | 81¨C87 % |
| Ralph Lauren Down Jacket | ~$75.41 | $400¨C$600 | 81¨C87 % |
| The North Face Down Jacket | ~$21.26 | $250¨C$350 | 91¨C94 % |
...
For luxury buyers, the Moncler Jacket at $72.36 and Moncler Down Jacket at $78.57 represent the biggest absolute-dollar savings, though you should expect shipping and potential customs to add $15¨C$30 to the final landed cost. Always factor that in before comparing to local retail.

If you are unsure about fit across these brands, our [Kakobuy sizing guide](/blog/kakobuy-sizing-guide/) breaks down measurements by brand and cuts so you order the right size the first time.
...
**Return rate:** 3.8 % for jackets, compared to 5.2 % across all apparel categories. Jackets have a lower return rate because sizing is less forgiving than, say, t-shirts (which is why we recommend checking our [Kakobuy t-shirts](/blog/kakobuy-t-shirts/) guide if you are buying tops as well).
...
None of these are deal-breakers for most buyers, but knowing them upfront helps you set realistic expectations. The platform's customer service team offers partial refunds (typically 15¨C25 % of order value) for documented quality issues, which keeps overall satisfaction at that 89.7 % mark.
...
Kakobuy Spreadsheet offers exchanges within 7 days of delivery for size swaps, though you cover return shipping. This is why checking measurements against the [Kakobuy sizing guide](/blog/kakobuy-sizing-guide/) before ordering is critical — returns eat into the savings.
